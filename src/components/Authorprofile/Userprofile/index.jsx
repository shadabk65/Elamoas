                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="middle-sidebar-left">
                            <div className="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden mb-3" style={{backgroundImage: "url("+"/images/userprofile.png"+")" }}>
                                <div className="card-body p-lg-5 p-4 bg-black-08">
                                    <div className="clearfix"></div>
                                    <div className="row">
                                        <div className="col-lg-12 pl-lg-5 pt-lg-5">
                                            <figure className="avatar ml-0 mb-4 position-relative w100 z-index-1"><img src="/images/author-user.png" alt="image" className="float-right p-1 bg-white rounded-circle w-100" /></figure>
                                        </div>
                                        <div className="col-lg-4 pl-lg-5 pb-lg-5 pb-3">
                                            ...
                                            <ul className="memberlist mt-3 mb-2 ">
                                                <li><a href="#"><img src="/images/author-icon1.png"  alt="user" className="w30 d-inline-block" /></a></li>
                                                <li><a href="#"><img src="/images/author-icon2.png"  alt="user" className="w30 d-inline-block" /></a></li>
                                                <li><a href="#"><img src="/images/author-icon3.png" alt="user" className="w30 d-inline-block" /></a></li>
                                                <li><a href="#"><img src="/images/author-icon4.png"  alt="user" className="w30 d-inline-block" /></a></li>
